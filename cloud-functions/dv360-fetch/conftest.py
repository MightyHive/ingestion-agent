...
# --- Bundled manifest -----------------------------------------------------
# In production, deploy.sh copies connectors-library/dv360/manifest.json
...
_MANIFEST_SRC = (
    _HERE.parent.parent / "connectors-library" / "dv360" / "manifest.json"
)
            ...
            json.dumps(
                {
                    "id": "dv360_reports",
                    "version": "0.0.0-test",
                    "endpoint": {"cloud_function_name": "dv360-fetch"},
                    "available_fields": [
