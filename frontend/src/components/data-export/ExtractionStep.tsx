...
export default function ExtractionStep({ data, onUpdate, projectId }: Props) {
  ...
  return (
    <div className="space-y-8 max-w-[1200px]">
      <div>
        <h2 className="text-2xl font-semibold text-on-surface">Create Extraction</h2>
      ...
      <section className="flex flex-col gap-3">
        ...
        {availablePlatforms.length === 0 ? (
          <p className="text-sm text-on-surface-variant">No templates available yet. Add one in Data Exploration.</p>
        ) : (
      ...
      <section className="flex flex-col gap-3">
        ...
        {!activePlatform ? (
          ...
          <p className="text-sm text-on-surface-variant">
            No compatible credentials for <strong>{activePlatform}</strong>. Add one in Platform Credentials.
          </p>
        ) : (
          <div className="flex flex-col gap-2">
